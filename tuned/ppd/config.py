...
class PPDConfig:
    ...
    def load_from_file(self, config_file):
        ...
        self._battery_detection = cfg.getboolean(MAIN_SECTION, BATTERY_DETECTION_OPTION, fallback=False)
        ...
        if not set(profile_dict_dc.keys()).issubset(profile_dict_ac.keys()):
            raise TunedException("Unknown PPD profile in the battery section.")
